...
def replace_bracketed_minutes(file_path):
    """
    Modify the input file in-place, replacing numbers between ', ' and 'p' with 00.
    ...
    try:
        ...
        # Replace numbers that appear between ', ' and 'p'
        modified_content = re.sub(r', (\d+)p', r', 00p', content)
