...
def main():
    ...
    # Regex to match the playlist loop line
    ...
    replacement = (
        ...
        '<button class="unstyled-button" onclick="javascript:loadYoutubePlaylistLoop(\'PL5_Ax8uKjgom18N4S8yUjBJ57U6R3kzmg\', true);">'
        '11. Dutiyabhikkhādāyikāvimānaṃ (3min.), 56p</button>'
        '<button class="unstyled-button" onclick="sharePagePlaylist(\'PL5_Ax8uKjgom18N4S8yUjBJ57U6R3kzmg\')">'
        ...
        'clip-rule="evenodd"/></svg></button></li>'
    )
